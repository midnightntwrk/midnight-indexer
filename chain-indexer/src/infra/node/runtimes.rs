...
#[subxt::subxt(runtime_metadata_path = "../.node/0.12.0-4337aca9/metadata.scale")]
mod runtime_0_12 {}

use crate::{domain::BlockHash, infra::node::SubxtNodeError};
use indexer_common::domain::{
    ApplyStage, ContractAddress, ContractState, ProtocolVersion, PROTOCOL_VERSION_000_012_000,
};
use itertools::Itertools;
use parity_scale_codec::Decode;
use std::collections::HashMap;
use subxt::{blocks::Extrinsics, events::Events, OnlineClient, SubstrateConfig};
