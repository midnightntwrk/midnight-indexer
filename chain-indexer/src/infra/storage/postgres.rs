...
use crate::domain::{
    storage::Storage, Block, BlockHash, BlockInfo, ContractAction, Transaction, UnshieldedUtxo,
};
use fastrace::trace;
use futures::{stream, Stream, StreamExt, TryStreamExt};
use indexer_common::{
    domain::ContractActionVariant,
    infra::{pool::postgres::PostgresPool, sqlx::U128BeBytes},
};
use indoc::indoc;
use sqlx::{postgres::PgRow, types::Json, Postgres, QueryBuilder, Row};
use std::iter;
