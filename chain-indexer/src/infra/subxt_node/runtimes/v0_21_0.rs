...
pub async fn fetch_authorities(
    ...
    let authorities = online_client
        ...
        .fetch(&super::runtime_0_21_0::storage().aura().authorities())
        .await
...
pub fn decode_slot(mut slot: &[u8]) -> Result<u64, SubxtNodeError> {
    let slot = super::runtime_0_21_0::runtime_types::sp_consensus_slots::Slot::decode(&mut slot)
        .map(|x| x.0)?;
    Ok(slot)
}
...
pub async fn get_contract_state(
    ...
    let get_state = super::runtime_0_21_0::apis()
...
pub async fn get_zswap_state_root(
    ...
    let get_zswap_state_root = super::runtime_0_21_0::apis()
        .midnight_runtime_api()
...
pub async fn get_transaction_cost(
    ...
    let get_transaction_cost = super::runtime_0_21_0::apis()
        .midnight_runtime_api()
...
pub async fn get_d_parameter(
    ...
    let get_d_param = super::runtime_0_21_0::apis()
...
pub async fn fetch_genesis_cnight_registrations(
    ...
    let query = super::runtime_0_21_0::storage()
        .c_night_observation()
        .mappings_iter();
...
pub async fn get_terms_and_conditions(
    ...
    let get_tc = super::runtime_0_21_0::apis()
        .system_parameters_api()
...
pub async fn get_ledger_state_root(
    ...
    let address = super::runtime_0_21_0::storage().midnight().state_key();
