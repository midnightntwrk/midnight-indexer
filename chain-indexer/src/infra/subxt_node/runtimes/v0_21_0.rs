...
pub async fn fetch_authorities(
    ...
    let authorities = block
        .storage()
        .entry(super::runtime_0_21_0::storage().aura().authorities())
...
pub async fn get_contract_state(
    ...
    let get_state = super::runtime_0_21_0::runtime_apis()
...
pub async fn get_transaction_cost(
    ...
    let get_transaction_cost = super::runtime_0_21_0::runtime_apis()
        .midnight_runtime_api()
...
pub async fn get_d_parameter(block: &OnlineClientAtBlock) -> Result<DParameter, SubxtNodeError> {
    let get_d_param = super::runtime_0_21_0::runtime_apis()
...
pub async fn get_terms_and_conditions(
    ...
    let get_tc = super::runtime_0_21_0::runtime_apis()
        .system_parameters_api()
