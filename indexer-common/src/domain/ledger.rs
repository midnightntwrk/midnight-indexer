...
use midnight_ledger::{
    error::MalformedTransaction as MalformedTransactionV6,
    structure::{ProofMarker as ProofMarkerV6, Transaction as TransactionV6},
};
...
pub enum Error {
    ...
    MalformedTransaction(#[from] MalformedTransactionV6<DefaultDBV6>),
}
