...
mod tests {
    use crate::{
        domain::{ByteVec, LedgerStateStorage, PROTOCOL_VERSION_000_014_000},
    ...
    async fn test() -> anyhow::Result<()> {
        ...
        ledger_state_storage
            .save(&default_state, 0, None, PROTOCOL_VERSION_000_014_000)
            .await
        ...
        assert_matches!(
            ledger_state,
            Some((state, 0, PROTOCOL_VERSION_000_014_000)) if state == default_state
        );
