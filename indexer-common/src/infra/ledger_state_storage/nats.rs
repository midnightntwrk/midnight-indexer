...
mod tests {
    use crate::{
        domain::{LedgerStateStorage, PROTOCOL_VERSION_000_013_000, ledger::LedgerState},
    ...
    async fn test() -> anyhow::Result<()> {
        ...
        let default_state = LedgerState::default().serialize().unwrap();
        ...
        ledger_state_storage
            .save(
                &LedgerState::default().serialize().unwrap(),
                42,
                Some(42),
